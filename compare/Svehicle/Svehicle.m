% simulation.m
function results = Svehicle(params)
    numVehicles = 1;%车辆数量   
    Ns = 50;%用户数量   
    ...
    vehicles =  [1.74144826097886;1.00350421275160];
    ...
    while ~converged
        ...
        if flag == Ns 
           ...
           save('Svehicle_nonProsTheor_expected_utility_converging.mat', 'expected_utility_converging');
           save('Svehicle_Probability_converging.mat', 'Probability_converging');
           disp(['当前迭代次数: ' num2str(iterations)]);  
        end
    end
...
%    results.bs1 = bs1;
%     results.bs2 = bs2;
%     results.vehicle1 = vehicle1;
%     results.vehicle2 = vehicle2;
%     results.vehicle3 = vehicle3;
%     results.vehicle4 = vehicle4;
    %% 画图3
    %% 画图1
    yyaxis left
